		...
		try {
			...
			mess = {
				...
				only: {
					...
					premium: '[❗] ESTE PEDIDO É SO PARA *USUÁRIOS PREMIUMKKS*',
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD DRAKE BOT*',
					...
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de DRAKE. Registre-se para fazer amizade com o bot DRAKE por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar DRAME|17\n\n──「 DRAKE BOT 」──`,
...
// recursos anime, random @DRAKE domina vida
			...
			break
               ...
               if (anu.error) return reply(anu.error)
                ...
                case 'ninjalogo':
                    ...
                    client.sendMessage(from, tod, image, { quoted: mek, caption: '*DRAKE domina ✓*'})
                    break
                    case 'animemenu':
          ...
          reply('Espere..')
				...
				if (!isGroup) return reply(mess.only.group)
					...
					break
			    case 'owner':
                    client.sendMessage(from, {displayname: "Jeff", }, MessageType.contact, { quoted: mek})
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* DRAKE☔\ wa.me/+5517988058041\n*INSTA:* @DRAKE__LINDO_\n\n\nEspero que tenham gostado do bot 🐊🚩️'})
					break
				case 'setprefix':
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
